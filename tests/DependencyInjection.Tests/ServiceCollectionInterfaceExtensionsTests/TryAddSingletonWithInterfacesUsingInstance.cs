...
public class TryAddSingletonWithInterfacesUsingInstance
{
    public TryAddSingletonWithInterfacesUsingInstance()
    {
    ...
    public void ShouldRegisterInterfaces()
    {
        ...
        serviceCollection.TryAddSingletonWithInterfaces(
            new NonDisposableService(new Dependency1Service(), new Dependency2Service(), new Dependency3Service()));
        serviceCollection.TryAddSingletonWithInterfaces(
            new DisposableService(new Dependency1Service(), new Dependency2Service(), new Dependency3Service()));
        serviceCollection.TryAddSingletonWithInterfaces(
            new AsyncDisposableService(new Dependency1Service(), new Dependency2Service(), new Dependency3Service()));
        serviceCollection.TryAddSingletonWithInterfaces(
            new BothDisposableService(new Dependency1Service(), new Dependency2Service(), new Dependency3Service()));
    ...
    [Fact]
    public async Task ShouldNotDisposeInstances()
    {
        var serviceCollection = new ServiceCollection();
        ...
        DisposableService.DisposableCallCount.Should().Be(0);
        AsyncDisposableService.DisposableCallCount.Should().Be(0);
        BothDisposableService.DisposableCallCount.Should().Be(0);
        BothDisposableService.AsyncDisposableCallCount.Should().Be(0);
    }
}
