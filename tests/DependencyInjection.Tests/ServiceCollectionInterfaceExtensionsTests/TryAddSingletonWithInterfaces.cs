...
public class TryAddSingletonWithInterfaces
{
    public TryAddSingletonWithInterfaces()
    {
    ...
    public void ShouldRegisterInterfaces()
    {
        ...
        serviceCollection.TryAddSingletonWithInterfaces(typeof(NonDisposableService));
        serviceCollection.TryAddSingletonWithInterfaces(typeof(DisposableService));
        serviceCollection.TryAddSingletonWithInterfaces(typeof(AsyncDisposableService));
        serviceCollection.TryAddSingletonWithInterfaces(typeof(BothDisposableService));
