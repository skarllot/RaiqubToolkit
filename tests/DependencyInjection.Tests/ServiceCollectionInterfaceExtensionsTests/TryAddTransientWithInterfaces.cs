...
public class TryAddTransientWithInterfaces
{
    public TryAddTransientWithInterfaces()
    {
    ...
    public void ShouldRegisterInterfaces()
    {
        ...
        serviceCollection.TryAddTransientWithInterfaces(typeof(NonDisposableService));
        serviceCollection.TryAddTransientWithInterfaces(typeof(DisposableService));
        serviceCollection.TryAddTransientWithInterfaces(typeof(AsyncDisposableService));
        serviceCollection.TryAddTransientWithInterfaces(typeof(BothDisposableService));
